...
<div class="flex items-center w-3/12 border border-gray-200 rounded-lg shadow">
    ...
    <div class="flex flex-col p-2 mx-2 leading-normal">
        <p class="mb-2 tracking-tight text-gray-900 dark:text-white">Jumlah Fitur Paket</p>
        <p id="fitur" class="mb-3 font-bold  text-gray-700 dark:text-gray-400">1</p>
    </div>
</div>
...
.then(apiData =>{
   // console.log(apiData);
        ...
        //console.log(item);
        item.forEach(fitur =>{
            const fitur_paket = document.getElementById('fitur');
            count_fitur = item.length;
            fitur_paket.textContent= count_fitur;
