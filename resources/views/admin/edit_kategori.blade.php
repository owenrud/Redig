...
if (idKategori) {
    // Tentukan URL API
    const apiUrl = `http://${Endpoint}/api/event/kategori/show`;
    ...
    fetch(apiUrl, fetchConfig)
        ...
        .then(apiData => {
            ...
            //console.log(apiData);
            const namaKategoriInput = document.getElementById('nama_kategoriUpdate');
...
<script>
    ...
    fetch(`http://${Endpoint}/api/event/kategori/update`, {
        method: 'POST',
        body: formData,
    })
    .then(response => response.json())
